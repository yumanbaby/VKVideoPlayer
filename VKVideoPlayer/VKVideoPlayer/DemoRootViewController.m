...
typedef enum {
  JSBCHLSViewController = 0,
  JSBCMainViewController,
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  switch (indexPath.row) {
    case JSBCHLSViewController:
      cell.textLabel.text = @"JSBC HLS Player Demo";
      break;
    case JSBCMainViewController:
      cell.textLabel.text = @"JSBC Config";
      break;
  }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        case JSBCHLSViewController:{
            viewController = [[VKVideoPlayerViewController alloc] init];
